...
void QGLViewer::setDefaultShortcuts() {
  ...
  setShortcut(ZOOM_TO_FIT_KEYBOARD, Qt::CTRL + Qt::Key_Equal); // Homemade
  ...
  keyboardActionDescription_[ZOOM_TO_FIT_KEYBOARD] =
      tr("Zoom to fit scene", "ZOOM_TO_FIT_KEYBOARD action description"); //Homemade
