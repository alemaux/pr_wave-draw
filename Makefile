...
CC            = gcc
CXX           = g++
DEFINES       = -DUNICODE -D_UNICODE -DWIN32 -DMINGW_HAS_SECURE_API=1 -DPNG_STATIC -DQT_NO_KEYWORDS -DQT_OPENGL_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_XML_LIB -DQT_CORE_LIB
CFLAGS        = -fno-keep-inline-dllexport -march=nocona -msahf -mtune=generic -Wa,-mbig-obj -g -Wall -Wextra -Wextra $(DEFINES)
CXXFLAGS      = -fno-keep-inline-dllexport -march=nocona -msahf -mtune=generic -Wa,-mbig-obj -g -fopenmp -O3 -D__MODE_DEBUG=3 -Wno-unused-parameter -Wno-unused-variable -Wno-unused-but-set-variable -DOPTIM_ENABLE_EIGEN_WRAPPERS -Wdeprecated-declarations -Wdeprecated-copy -g -g -frtti -Wall -Wextra -Wextra -fexceptions -mthreads $(DEFINES)
...
LIBS        =        -LQGLViewer QGLViewer/libQGLViewer2.dll.a -lpthread -lgomp -fopenmp -LC:/msy64/mingw64/lib -lpng -LC:/msys64/mingw64/bin -lSDL2 -lSDL2_image -LQGLViewer -lQGLViewer2 -lpng16 -lz -lopengl32 -lglu32 -L../../QGLViewer -lQGLViewerd2 C:/msys64/mingw64/lib/libQt5OpenGL.dll.a C:/msys64/mingw64/lib/libQt5Widgets.dll.a C:/msys64/mingw64/lib/libQt5Gui.dll.a C:/msys64/mingw64/lib/libQt5Xml.dll.a C:/msys64/mingw64/lib/libQt5Core.dll.a   
...
moc_predefs.h: C:/msys64/mingw64/share/qt5/mkspecs/features/data/dummy.cpp
	g++ -fno-keep-inline-dllexport -march=nocona -msahf -mtune=generic -Wa,-mbig-obj -g -fopenmp -O3 -D__MODE_DEBUG=3 -Wno-unused-parameter -Wno-unused-variable -Wno-unused-but-set-variable -DOPTIM_ENABLE_EIGEN_WRAPPERS -Wdeprecated-declarations -Wdeprecated-copy -g -g -frtti -Wall -Wextra -Wextra -dM -E -o moc_predefs.h C:/msys64/mingw64/share/qt5/mkspecs/features/data/dummy.cpp
...
obj/plotter.o: src/plotter.cpp src/plotter.hpp \
		src/WaterSurface.hpp \
		src/definitions.hpp \
		src/Wave.hpp \
		src/Grid.hpp \
		...
		src/error.hpp \
		src/ExceptionSimu.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/plotter.o src/plotter.cpp
...
obj/wavedraw.o: src/wavedraw.cpp src/wavedraw.hpp \
		src/definitions.hpp \
		src/settings.hpp \
		src/EquivalentSource.hpp \
		src/Wave.hpp \
		...
		src/error.hpp \
		src/ExceptionSimu.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/wavedraw.o src/wavedraw.cpp
